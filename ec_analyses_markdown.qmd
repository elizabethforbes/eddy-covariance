...
There are no significant deviations from the reference mean ecosystem respiration rate (conventional mature; \~2.6gC/m2/day) for any crop stage; similarly, when accounting for climate, there is no meaningful varying in ecosystem respiration across management systems.
...
The complexity of the relationship between climate and respiration is demonstrated in the heatmap above, where it is clear that there is a large 'middle ground' of climate conditions (\~10-20C, low to moderate VPD) during which the organic field exhibits low respiration rates, relative to its own mean. These conditions are typical to those that the field is experiencing for most of the growing season, indicating that organic soils under typical summer conditions are respiring less than they do in other weather. However, higher VPD (e.g., dry conditions) across a wider temperature range drives relatively high/elevated respiration in organic. In short: when air is hot and dry (high evaporative pressure for plants), respiration spikes in the conventional field in a way that does not occur in the conventional field. This might be due to the (probable) higher abundance and diversity of soil microbes, with more substrate available as organic matter, that become active during stressful (dry) conditions.

In contrast, the low complexity (EDF = 3) of the relationship that the conventional field has with climate is very straightforward. There is not a hugely compelling relationship with evaporative stress (VPD), and as air temperatures increase, so does respiration. This indicates that, while following expected patterns, the biology of the soil is likely not as complex/diverse/active in the conventional field as that in the organic field.

#### Ecos. Resp. takeaways:

The outcomes of the ecosystem respiration analysis reveal that there is not crop-stage dependence for either field, unlike GPP and NEE (for which the conventional field has high crop-stage dependence). The biggest takeaway is that the observed patterns in NEE are likely driven by management and crop-stage differences in GPP, not respiration. Additionally, the climate dependence in both fields for respiration makes biological sense; however, there are distinct differences in the complexity of that dependence, indicating that soil health is likely elevated in the organic field and producing variability that does not exist for the conventional soil.
