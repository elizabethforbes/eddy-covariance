...
plot_timeseries_with_stages(data1, flux_var = "NEE_gapfilled")
plot_timeseries_with_stages(data1, flux_var = "GPP_gapfilled")
plot_timeseries_with_stages(data1, flux_var = "Reco_gapfilled")
